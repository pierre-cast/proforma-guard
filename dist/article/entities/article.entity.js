...
], ArticleEntity.prototype, "date", void 0);
__decorate([
    typeorm_1.Column(),
...
__decorate([
    typeorm_1.Column(),
    __metadata("design:type", Boolean)
], ArticleEntity.prototype, "complete", void 0);
__decorate([
    typeorm_1.ManyToOne(type => author_entity_1.AuthorEntity, (author) => author.articles, {
        nullable: true,
        eager: true
    }),
